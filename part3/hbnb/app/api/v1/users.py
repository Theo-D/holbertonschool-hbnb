...
class UserList(Resource):
    @jwt_required()
    @ns.doc("list_users", description="List all user accounts (Admin only)", security='BearerAuth')
    ...
    @ns.doc("create_user", description="Create a new user account (first is admin, then admin-only)", security=[])
...
class UserResource(Resource):
    @jwt_required()
    @ns.doc("get_user", description="Retrieve user details (Self or Admin)", security='BearerAuth')
    ...
    @jwt_required()
    @ns.doc("update_user", description="Update user profile (Self or Admin)", security='BearerAuth')
    ...
    @jwt_required()
    @ns.doc("delete_user", description="Delete a user (Self or Admin)", security='BearerAuth')
